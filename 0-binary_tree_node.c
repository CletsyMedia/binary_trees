 ...
 * initializes its value and parent, and sets the left and right children to NULL.
 *
 * Return: If memory allocation fails, returns NULL. Otherwise, returns a pointer
